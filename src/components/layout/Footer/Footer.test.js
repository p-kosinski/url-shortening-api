...
describe('Footer component', () => {
  it('renders home page link (first in order)', () => {
    render(<Footer />);
  ...
  it('renders first \'Features\' list  with \'Link Shortening\', \'Branded Links\' and \'Analytics\' links', () => {
    ...
    const allListTitles = screen.getAllByTestId('footer-link-list-title');
  ...
  it('renders facebook, twitter, pinterest and instagram external icon links', () => {
    ...
    const iconLinksWrapper = screen.getByTestId('icon-links');
